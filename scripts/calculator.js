import {
  ...
  handleAllClearBtnClick,
  handleOperatorBtnClick,
  handleEqualBtnClick
} from "./utils/handle-click.js";
...
equalButtonElement.addEventListener("click", () => {
  Object.assign(variables, handleEqualBtnClick(variables))
});
...
export const allClearButtonElement = document.querySelector(
  ".all-clear-button-js"
);
